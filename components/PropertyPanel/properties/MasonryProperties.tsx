...
interface MasonryPropertiesProps {
  block: Block;
  updateStyle: (key: string, value: any) => void;
  updateContent: (value: any) => void;
}

export const MasonryProperties: React.FC<MasonryPropertiesProps> = ({
  block,
  updateStyle,
  updateContent,
}) => {
  ...
  return (
    <>
      <PropertySection>
        <PropertyLabel style={{ color: '#ff4444' }}>*Gambar Masonry</PropertyLabel>
        ...
        <PropertyNote>
          Tambahkan gambar untuk masonry layout. Gambar akan ditampilkan dalam grid responsif.
        </PropertyNote>
      </PropertySection>
